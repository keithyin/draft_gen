...
struct ConsensusSettings
{
    ...
    std::string WlSpec;
    bool ZmwTimings;
    std::string PoaErrSpanVersion;
    std::string PoaIdentityVersion;
    std::string PassesCntVersion;
    std::string ReComputePoaIdentityVersion;
    int BamCompressionLevel;
    size_t BamThreads;
    int MatchScore = 3;
    int MismatchScore = -5;
    int InsertionScore = -4;
    int DeletionScore = -4;

    ConsensusSettings(): LogLevel(Logging::LogLevel(2)){
    };
