...
public:
    ...
    std::vector<float> BaseLevelCrs() const;
    std::vector<float> BaseLevelDwMeans() const;
    std::vector<float> BaseLevelDwVars() const;
...
public:
    ...
    Frames CR(Orientation orientation = Orientation::NATIVE, bool aligned = false,
               bool exciseSoftClips = false) const;
