...
const BamRecordTags::TagLookupType BamRecordTags::tagLookup =
{
    ...
    { BamRecordTag::HOLE_NUMBER,       {"ch", false} },
    { BamRecordTag::INSERTION_QV,      {"iq", false} },
    { BamRecordTag::IPD,               {"ip", false} },
    { BamRecordTag::CAPTURE_RATE,      {"cr", false} },
    ...
    { BamRecordTag::PULSE_WIDTH,       {"dw", false} }, // 'pulse' in the name; but stored per-base, not per-pulse
    ...
    { BamRecordTag::BASE_LEVEL_CRS,               {"c1", false} },
    { BamRecordTag::BASE_LEVEL_DW_MEANS,          {"d1", false} },
    { BamRecordTag::BASE_LEVEL_DW_VARS,           {"d2", false} },
